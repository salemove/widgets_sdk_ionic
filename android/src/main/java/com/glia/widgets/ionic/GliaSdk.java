...
public class GliaSdk {
    ...
    public void configure(PluginCall call, Activity activity) {
        ...
        Boolean enableBubbleOutsideApp = call.getBoolean("enableBubbleOutsideApp", false);
        Boolean enableBubbleInsideApp = call.getBoolean("enableBubbleInsideApp", false);
        ...
        GliaWidgets.getQueues( response -> {
            if (response == null) {
                ...
                for (Queue queue : response) {
                    ...
                    for (MediaType mediaType : queue.getMedias()) {
    ...
    public void getVisitorInfo(PluginCall call) {
        try {
            GliaWidgets.getVisitorInfo(visitorInfo -> {
                ...
                if (visitorInfo.getCustomAttributesMap() != null) {
                    for (String key : visitorInfo.getCustomAttributesMap().keySet()) {
                        customAttributes.put(key, visitorInfo.getCustomAttributesMap().get(key));
                    }
                }
