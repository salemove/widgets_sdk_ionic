...
#### Fixed
- Updated the iOS dynamic linkage script to properly include Telemetry dependencies.
- Introduced a new linkage script to prevent the "Duplicated Symbols" issue.
